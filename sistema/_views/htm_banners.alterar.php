           ...
           <div id="dados" class="tab-pane <?php if($aba_selecionada == "dados"){ echo "active"; } ?>" >
             <form action="<?=$_base['objeto']?>alterar_grv" class="form-horizontal" method="post">  						
              ...
              <fieldset>
                ...
                <div class="form-group">
                  <label class="col-md-12">Mostrar na Categoria de Produtos</label>
                  <div class="col-md-7">
                    <select name="grupo_produtos" class="form-control select2" style="width: 100%;" >
                      <option value='' selected >Todas</option>
                      <?php
                      
                      foreach ($categorias_produtos as $key => $value) {
                        
                        if($value['codigo'] == $data->grupo_produtos){
                          $selected = " selected ";
                        } else {
                         $selected = "";
                       }
