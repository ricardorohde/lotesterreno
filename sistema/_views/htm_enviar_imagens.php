...
if($_base['navegador'] == "Safari"){
  ...
  <div>
    <form action="<?=$_base['objeto']?>imagem_manual/codigo/<?=$codigo?>" method="post" enctype="multipart/form-data">
      ...
      <div style="padding-bottom:20px;">Para envio de imagens grandes ou com tamanho superior a 2mb utilize o navegador Google Chrome, Firefox ou Internet Explorer.</div>
