<form action="<?=DOMINIO?>faleconosco/desejo_enviar" method="post" name="form_contato" id="form_contato" >
	...
	<div class="modal-body">	 
		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-12 col-md-12">
				...
				<div class='modal_texto' >Interesse no imovel Ref.:</div>
				<div class='modal_input_div'>
					<input name='imovel' class='modal_input' style='width:100%;' value="<?=$data->id?> - <?=$data->titulo?>" >
				</div>
