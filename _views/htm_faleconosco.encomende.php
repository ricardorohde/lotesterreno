<form action="<?=DOMINIO?>faleconosco/encomende_enviar" method="post" name="form_encomende" id="form_encomende" >

	<div class="modal-header">
		<button type="button" class="close" data-dismiss="modal" >&times;</button>
		<h4 class="modal-title">Imóvel sob encomenda</h4>
	</div>
	...
	<div class="modal-body">
		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12">
				...
				<div class='modal_texto' >Descreva as caracteristicas do imóvel que deseja:</div>
	...
	<div class="modal-footer">
		<button type="button" class="btn btn-success" onClick="form_encomende.submit();" >Enviar</button>
